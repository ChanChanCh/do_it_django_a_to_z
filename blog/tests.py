...
class TestView(TestCase):
    def setUp(self):
        self.client = Client()
        self.user_trump = User.objects.create_user(username='trump',password='sompassword')
        self.user_obama = User.objects.create_user(username='obama',password='sompassword')
